  ...
  !(function (e) {
    ...
    (function () {
      ...
      p &&
        ...
        document.querySelectorAll('.tab__item, .main__swiper-1, .main__swiper-2, .tab__nav-btn').forEach((s) => {
          s.addEventListener('mouseover', function () {
        ...
        ((e, t, s, i, n) => {
          ...
          document.querySelector('.main__swiper-slide'),
          document.querySelector('.main__swiper-img-content'),
          document.querySelectorAll('.main__btns-js'),
          document.querySelector('.main__swiper-content'),
          document.querySelectorAll('.main__pagination-js')
        );
      const u = document.querySelectorAll('.tab__nav-btn'),
        h = document.querySelectorAll('.tab__items');
      u &&
