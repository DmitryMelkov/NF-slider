(() => {
  ...
  const u = {
          ...
          if (
            ...
            for (let e = r.length - 1; e >= 0; e -= 1) {
              ...
              (i && s.listener === i) || (i && s.listener && s.listener.dom7proxy && s.listener.dom7proxy === i)
                ...
                : i || (a.removeEventListener(t, s.proxyListener, n), r.splice(e, 1));
            }
        }
      }
      return this;
    ...
    prepend: function (e) {
      ...
      for (s = 0; s < this.length; s += 1)
        ...
        } else if (e instanceof r) for (n = 0; n < e.length; n += 1) this[s].insertBefore(e[n], this[s].childNodes[0]);
  ...
  const E = {
    ...
    x = {
        ...
        for (let n = 0; n < p; n += 1) {
          ...
          if ((E && e.grid.updateSlide(n, r, p, t), 'none' !== r.css('display'))) {
            if ('auto' === i.slidesPerView) {
              ...
              if ((l && (r[0].style.transform = 'none'), o && (r[0].style.webkitTransform = 'none'), i.roundLengths))
            ...
            c[n] && (c[n].swiperSlideSize = x),
              ...
              i.centeredSlides
                ? ((y = y + x / 2 + T / 2 + C),
                  ...
                  h.push(y))
                : (i.roundLengths && (y = Math.floor(y)),
                  (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && u.push(y),
                  h.push(y),
                  (y = y + x + C)),
              (e.virtualSize += x + C),
              (T = x),
      ...
      updateSlidesProgress: function (e = (this && this.translate) || 0) {
        ...
        for (let e = 0; e < i.length; e += 1) {
          ...
          ((p >= 0 && p < t.size - 1) || (u > 1 && u <= t.size) || (p <= 0 && u >= t.size)) &&
            (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e), i.eq(e).addClass(s.slideVisibleClass)),
            (l.progress = n ? -d : d),
      ...
      updateProgress: function (e) {
        ...
        const l = a,
          o = r;
        0 === i ? ((n = 0), (a = !0), (r = !0)) : ((n = (e - t.minTranslate()) / i), (a = n <= 0), (r = n >= 1)),
        ...
        t.removeClass(
          ...
          s.loop &&
            (l.hasClass(s.slideDuplicateClass)
              ? i
                  .children(`.${s.slideClass}:not(.${s.slideDuplicateClass})[data-swiper-slide-index="${a}"]`)
                  .addClass(s.slideDuplicateActiveClass)
              : i
                  .children(`.${s.slideClass}.${s.slideDuplicateClass}[data-swiper-slide-index="${a}"]`)
                  .addClass(s.slideDuplicateActiveClass));
    ...
    slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
      ...
      if (l.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!a.support.smoothScroll) return w({ swiper: a, targetPosition: s, side: e ? 'left' : 'top' }), !0;
  ...
  function k(e) {
    ...
    if (
      ...
      let e = !0;
      p.is(r.focusableElements) && ((e = !1), 'SELECT' === p[0].nodeName && (r.isTouched = !1)),
        s.activeElement &&
  ...
  function L(e) {
    ...
    if (!s.allowTouchMove)
      return (
        ...
        void (
          n.isTouched &&
          (Object.assign(r, { startX: p, startY: u, currentX: p, currentY: u }), (n.touchStartTime = m()))
        )
      );
    if (n.isTouchEvent && a.touchReleaseOnEdges && !a.loop)
      if (s.isVertical()) {
        ...
        return;
    if (n.isTouchEvent && t.activeElement && d.target === t.activeElement && h(d.target).is(n.focusableElements))
    ...
    if (void 0 === n.isScrolling) {
      ...
      (s.isHorizontal() && r.currentY === r.startY) || (s.isVertical() && r.currentX === r.startX)
        ...
        : f * f + g * g >= 25 &&
          ...
          (n.isScrolling = s.isHorizontal() ? e > a.touchAngle : 90 - e > a.touchAngle));
    }
    if (
    ...
    if (
      ...
      v > 0 && n.currentTranslate > s.minTranslate()
        ? ((b = !1),
          a.resistance && (n.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + n.startTranslate + v) ** w))
        : v < 0 &&
          n.currentTranslate < s.maxTranslate() &&
          ((b = !1),
          a.resistance && (n.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - n.startTranslate - v) ** w)),
  ...
  function P(e) {
    ...
    if (c > i.longSwipesMs) {
      ...
      'next' === t.swipeDirection &&
        (b >= i.longSwipesRatio ? t.slideTo(i.rewind && t.isEnd ? g : u + w) : t.slideTo(u)),
  ...
  const D = (e, t) => {
      const s = i(),
        { params: n, touchEvents: a, el: r, wrapperEl: l, device: o, support: d } = e,
        c = !!n.nested,
      ...
      if (d.touch) {
        ...
        r[p](a.start, e.onTouchStart, t),
          r[p](a.move, e.onTouchMove, d.passiveListener ? { passive: !1, capture: c } : c),
      ...
      (n.preventClicks || n.preventClicksPropagation) && r[p]('click', e.onClick, !0),
        n.cssMode && l[p]('scroll', e.onScroll),
        n.updateOnWindowResize
          ? e[u](o.ios || o.android ? 'resize orientationchange observerUpdate' : 'resize observerUpdate', O, !0)
    ...
    G = {
      attachEvents: function () {
        ...
        (e.onTouchStart = k.bind(e)),
          ...
          (e.onClick = A.bind(e)),
          n.touch && !z && (t.addEventListener('touchstart', _), (z = !0)),
          D(e, 'on');
      },
        ...
        translateTo: function (e = 0, t = this.params.speed, s = !0, i = !0, n) {
          ...
          if (((c = i && e > o ? o : i && e < d ? d : e), a.updateProgress(c), r.cssMode)) {
            ...
            if (0 === t) l[e ? 'scrollLeft' : 'scrollTop'] = -c;
              ...
              if (!a.support.smoothScroll) return w({ swiper: a, targetPosition: -c, side: e ? 'left' : 'top' }), !0;
          ...
          return (
            0 === t
              ? (a.setTransition(0),
                a.setTranslate(c),
                s && (a.emit('beforeTransitionStart', t, n), a.emit('transitionEnd')))
              : (a.setTransition(t),
                a.setTranslate(c),
      ...
      transition: {
        ...
        transitionStart: function (e = !0, t) {
          const s = this,
            { params: i } = s;
          i.cssMode ||
            (i.autoHeight && s.updateAutoHeight(), M({ swiper: s, runCallbacks: e, direction: t, step: 'Start' }));
        },
        transitionEnd: function (e = !0, t) {
          const s = this,
            { params: i } = s;
          (s.animating = !1),
            i.cssMode || (s.setTransition(0), M({ swiper: s, runCallbacks: e, direction: t, step: 'End' }));
        },
      },
      slide: $,
      loop: {
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const o = (l in r ? r[l] : void 0) || e.originalParams,
            ...
            p = n.enabled;
          d && !c
            ? (a.removeClass(`${n.containerModifierClass}grid ${n.containerModifierClass}grid-column`),
              ...
              ((n = new ResizeObserver((t) => {
                r = i.requestAnimationFrame(() => {
                  ...
                  t.forEach(({ contentBoxSize: t, contentRect: s, target: i }) => {
                    (i && i !== e.el) ||
                      ((n = s ? s.width : (t[0] || t).inlineSize), (a = s ? s.height : (t[0] || t).blockSize));
                  }),
                    (n === s && a === i) || l();
                });
              })),
  ...
  function X({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function d() {
      ...
      if (
        ((e.params.navigation = R(e, e.originalParams.navigation, e.params.navigation, {
  ...
  function U({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function p() {
      e.params.pagination = R(e, e.originalParams.pagination, e.params.pagination, { el: 'swiper-pagination' });
      const t = e.params.pagination;
      if (!t.el) return;
      let s = h(t.el);
      0 !== s.length &&
        (e.params.uniqueNavElements &&
          'string' == typeof t.el &&
          s.length > 1 &&
          ((s = e.$el.find(t.el)), s.length > 1 && (s = s.filter((t) => h(t).parents('.swiper')[0] === e.el))),
  ...
  function K({ swiper: e, extendParams: t, on: s, emit: n }) {
    ...
    function o() {
      return (
        !!e.autoplay.running &&
        void 0 !== a &&
        (a && (clearTimeout(a), (a = void 0)), (e.autoplay.running = !1), n('autoplayStop'), !0)
      );
    }
    function d(t) {
      e.autoplay.running &&
  ...
  !(function (e) {
    ...
    (function () {
      var e = new W('.main__swiper-1', {
          ...
          speed: 500,
          navigation: { nextEl: '.main__btn-next', prevEl: '.main__btn-prev' },
          pagination: { el: '.main__pagination-js' },
        }),
        t = new W('.main__swiper-2', {
          modules: [U, X, K],
          loop: !0,
          slidesPerView: 'auto',
          autoplay: { delay: 1e3, disableOnInteraction: !1 },
      ...
      const s = document.querySelector('.tab-slide-1'),
        i = document.querySelector('.tab-slide-2'),
        n = document.querySelector('.tab-slide-3'),
        a = document.querySelector('.tab-slide-4'),
        r = document.querySelector('.tab-slide-5'),
        l = document.querySelector('.tab-slide-6'),
        o = document.querySelector('.tab-slide-7'),
        d = document.querySelector('.tab-slide-8'),
        c = document.querySelector('.tab-slide-9'),
        p = document.querySelector('.tab-slide-10');
      p &&
        ...
        document.querySelectorAll('.tab__item, .main__swiper-1, .main__swiper-2').forEach((s) => {
          s.addEventListener('mouseover', function () {
            e.autoplay.stop(), t.autoplay.stop();
          }),
            s.addEventListener('mouseout', function () {
              e.autoplay.start(), t.autoplay.start();
            });
        });
      const u = document.querySelector('.main__swiper-slide'),
        h = document.querySelector('.main__swiper-img-content'),
        f = document.querySelectorAll('.main__btns-js'),
        m = document.querySelector('.main__swiper-content'),
        g = document.querySelectorAll('.main__pagination-js');
      console.log(u.offsetHeight),
        console.log(h.offsetHeight),
        console.log(m.offsetHeight),
        ((e, t, s, i, n) => {
          if (i) {
            let a = e.offsetHeight - (t.offsetHeight + i.offsetHeight),
              r = Math.floor(t.offsetHeight / 2) + 'px',
              l = Math.floor(i.offsetHeight + a + 30) + 'px';
            s.forEach((e) => {
              e.style.top = r;
            }),
              n.forEach((e) => {
      ...
      const v = document.querySelectorAll('.tab__nav-btn'),
        b = document.querySelectorAll('.tab__items');
      v &&
        v.forEach(function (s) {
          s.addEventListener('click', function () {
            let i = s,
              n = i.getAttribute('data-tab'),
